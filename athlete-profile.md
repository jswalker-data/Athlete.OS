...
## Experience
Used to run a lot when younger. Took it up seriously again 6-8 weeks ago (started roughly early-to-mid June 2026). Biggest race completed so far: a parkrun (5k). Currently building back toward half-marathon fitness.

## Goal
**Race:** Ealing Half Marathon
**Date:** 2026-09-27
**Target time:** 1:42:00 (7:47/mile, 4:50/km) — locked 2026-07-20
**Timeline:** ~10 weeks out as of 2026-07-20
Very focused on getting this specific time — this is the primary training target right now.

Note: original ask was 1:20:00. Reassessed against actual fitness data (21:40 parkrun 5k) and revised down to a realistic, safe target given short training base and knee/hip history. Sub-1:30 remains a stretch/upside goal if training goes cleanly, not the base plan.

## Training availability
- Flexible on hours — can do "whatever is needed" to hit the goal
- Can train mornings
- Hard no: Thursday evenings
- Wants Saturday parkruns integrated into the plan (not treated as separate from training)
...
- A mix of running and other exercise, programmed at the coach's discretion (not just running)
- A plan that adapts in real time to how life actually goes (rough sleep week, low-step day, etc.), not a static fixed plan
- Strength training integrated alongside running, focused on knee/hip resilience
